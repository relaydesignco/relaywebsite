<template>
  <div class="careers detail wrapper">
    <!--
...
<script>
  ...
  export default {
        ...
        careers: [
          {
            ...
            url:'/careers/digital-designer',
          },
          {
            title:'Front-end Developer',
            url:'/careers/front-end-developer',
          },
        ]
      }
    },
    head: {
      ...
      meta: [
        { name: 'description', content: 'Relay is now hiring. View our current openings.'},
